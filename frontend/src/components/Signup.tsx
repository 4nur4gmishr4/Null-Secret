            ...
            <div className="hidden lg:flex lg:w-1/2 relative rounded-3xl overflow-hidden p-8 flex-col justify-between" style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border-default)' }}>
                ...
                <div className="relative z-10">
                    <h1 className="text-4xl xl:text-5xl font-bold leading-[1.1] tracking-tight">
                        Create your <br /> Null-Secret account
                    </h1>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
                <div className="w-full max-w-[380px] space-y-4">
                    ...
                    <div className="space-y-2">
                        <button onClick={handleGoogleSignUp} type="button" className="w-full flex items-center justify-center gap-2.5 py-2.5 bg-transparent rounded-none transition-colors text-[14px] font-medium hover:opacity-80" style={{ border: '1px solid var(--border-default)' }}>
                    ...
                    <div className="text-center flex flex-col space-y-2 pt-1 text-[13px]">
                        <p style={{ color: 'var(--text-tertiary)' }}>
                            Already have an account? <Link to="/login" className="font-medium underline underline-offset-4 ml-1" style={{ color: 'var(--text-secondary)' }}>Sign in instead</Link>
                        </p>
                    </div>
                </div>
            </div>

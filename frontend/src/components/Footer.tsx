        ...
        <div className="w-full flex flex-col justify-center font-sans pt-8 md:pt-12 pb-24 md:pb-[18rem] px-4 sm:px-6 lg:px-8 relative overflow-hidden" style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
            ...
            <div className="w-full max-w-4xl mx-auto border p-8 lg:p-12 z-10 relative shadow-2xl" style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-default)' }}>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-8 lg:gap-y-0">
                    ...
                    {/* Product + Resources share a row on mobile */}
                    <div className="grid grid-cols-2 lg:grid-cols-5 lg:col-span-5 border-b lg:border-b-0 lg:border-r overflow-hidden" style={{ borderColor: 'var(--border-default)' }}>
                    {/* Column 2: Product */}
                    <div className="lg:col-span-3 flex flex-col py-8 pr-6 lg:py-0 lg:pl-8 lg:pr-8 border-r" style={{ borderColor: 'var(--border-default)' }}>
                    ...
                    {/* Column 3: Resources */}
                    <div className="lg:col-span-2 flex flex-col py-8 pl-6 lg:py-0 lg:pl-8 lg:pr-8" style={{ borderColor: 'var(--border-default)' }}>
                    ...
                    <div className="lg:col-span-3 flex flex-col pt-8 lg:pt-0 lg:pl-8">
                        ...
                        <ul className="flex flex-wrap gap-x-6 gap-y-3 lg:block lg:space-y-3 flex-1">
                            <li>
                            ...
                            <li>
                                <a href="https://www.linkedin.com/in/4nur4gmishra/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:opacity-75 transition-opacity text-[14px]" style={{ color: 'var(--text-secondary)' }}>
